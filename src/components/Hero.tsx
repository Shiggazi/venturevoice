...
function WorkflowDiagram() {
  return (
    ...
    >
      {/* wires */}
      <path id="w1" d="M150 96 C 200 96, 200 96, 250 96" className="wire" stroke="#2e5bff" strokeWidth="2" fill="none" />
      <path id="w2" d="M320 124 C 320 160, 250 160, 220 190" className="wire" stroke="#ffb224" strokeWidth="2" fill="none" />
      <path id="w3" d="M320 124 C 320 160, 390 160, 420 190" className="wire" stroke="#ffb224" strokeWidth="2" fill="none" style={{ animationDelay: "0.4s" }} />

      {/* traveling pulse dots */}
      <circle r="4" fill="#7d9bff" className="pulse-dot">
        <animateMotion dur="3s" repeatCount="indefinite">
          <mpath href="#w1" />
        </animateMotion>
      </circle>
      <circle r="4" fill="#ffd27a" className="pulse-dot">
      ...
      <g className="node-pop">
        ...
        <circle cx="52" cy="96" r="2.5" fill="#2fd180" className="live-dot" />
      ...
      <g className="node-pop" style={{ animationDelay: "0.9s" }}>
        ...
        <circle cx="124" cy="306" r="4" fill="#2fd180" className="live-dot" />
  ...
  return (
    <section className="canvas-grid relative overflow-hidden">
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 pb-16 pt-16 md:grid-cols-[1.05fr_0.95fr] md:pb-20 md:pt-24">
        <div>
          <p className="eyebrow node-pop text-amber">{settings.heroEyebrow}</p>
          <h1
          ...
          <div className="node-pop mt-8 flex flex-wrap items-center gap-4" style={{ animationDelay: "0.3s" }}>
            <Link
              href="/#contact"
              className="btn rounded-lg bg-cobalt px-6 py-3.5 text-[15px] font-semibold text-white shadow-[0_8px_24px_rgba(46,91,255,0.35)] hover:bg-cobalt-deep hover:shadow-[0_12px_32px_rgba(46,91,255,0.45)]"
            >
      ...
      <div className="border-t border-line-dark bg-ink/60 backdrop-blur-sm">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-y-6 px-5 py-8 sm:grid-cols-4">
          ...
          <div>
            <p className="font-mono text-2xl font-bold text-amber md:text-3xl">n8n · Make · Zapier</p>
